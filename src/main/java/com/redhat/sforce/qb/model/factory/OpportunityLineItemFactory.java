	...
	public static JSONArray serialize(List<OpportunityLineItem> opportunityLineItemList) {
		...
		for (OpportunityLineItem opportunityLineItem : opportunityLineItemList) {
			...
			try {
				...
				jsonObject.put("ActualEndDate__c", Util.dateFormat(opportunityLineItem.getActualEndDate()));
				...
				jsonObject.put("ActualStartDate__c", Util.dateFormat(opportunityLineItem.getActualStartDate()));
