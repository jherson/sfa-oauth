...
public class CreditCheckFactory {
	...
	public static List<CreditCheck> deserialize(JSONArray jsonArray)
		...
		for (int i = 0; i < jsonArray.length(); i++) {
			...
			creditCheck.setArPastDueAmount(wrapper
					.getDouble("A_R_Past_Due_Amount__c"));
			...
			creditCheck.setBillingAccountNameUsed(wrapper
					.getString("BillingAccountNameUsed__c"));
			creditCheck.setBillingAccountNumberUsed(wrapper
					.getString("BillingAccountNumberUsed__c"));
