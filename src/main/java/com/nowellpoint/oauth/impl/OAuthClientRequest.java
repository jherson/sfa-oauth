...
public class OAuthClientRequest {
	...
	public static class BasicTokenRequestImpl implements BasicTokenRequest {
		...
		private BasicTokenRequestImpl(BasicTokenRequestBuilder builder) {
	...
	public static class BasicTokenRequestBuilder {
		...
		public BasicTokenRequest build() {
			return new BasicTokenRequestImpl(this);
		}
	}

	public static class VerifyTokenRequestImpl implements VerifyTokenRequest {
		private String code;
		private String callbackUrl;
		private String clientId;
		private String clientSecret;

		private VerifyTokenRequestImpl(VerifyTokenRequestBuilder builder) {
	...
	public static class VerifyTokenRequestBuilder {
		...
		public VerifyTokenRequest build() {
			return new VerifyTokenRequestImpl(this);
		}
	}

	public static class IdentityRequestImpl implements IdentityRequest {
		private String identityUrl;
		private String accessToken;

		private IdentityRequestImpl(IdentityRequestBuilder builder) {
	...
	public static class IdentityRequestBuilder {
		...
		public IdentityRequest build() {
			return new IdentityRequestImpl(this);
		}
	}

	public static class RefreshTokenRequestImpl implements RefreshTokenRequest {
		private String refreshToken;
		private String clientId;
		private String clientSecret;

		private RefreshTokenRequestImpl(RefreshTokenRequestBuilder builder) {
	...
	public static class RefreshTokenRequestBuilder {
		...
		public RefreshTokenRequest build() {
			return new RefreshTokenRequestImpl(this);
		}
	}

	public static class RevokeTokenRequestImpl implements RevokeTokenRequest {
		private String accessToken;

		private RevokeTokenRequestImpl(RevokeTokenRequestBuilder builder) {
			this.accessToken = builder.accessToken;
		}
	...
	public static class RevokeTokenRequestBuilder {
		...
		public RevokeTokenRequest build() {
			return new RevokeTokenRequestImpl(this);
		}
	}
}